...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + "coarse_annotations_new/quasi-center-point-0-0-0.25-0.25-0.25_1/qc_instances_train2017_coarse_with_gt.json",
    ...
    val=dict(
        samples_per_gpu=1,
        type=dataset_type,
        ann_file=data_root + "coarse_annotations_new/quasi-center-point-0-0-0.25-0.25-0.25_1/qc_instances_val2017_coarse_with_gt.json",
        img_prefix=data_root + 'images/val',  # 'train2017/',
